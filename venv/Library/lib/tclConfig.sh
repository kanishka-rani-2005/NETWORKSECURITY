...
# installed.
TCL_PREFIX='E:/NetworkSecurity/venv\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='E:/NetworkSecurity/venv\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='E:/NetworkSecurity/venv\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-IE:/NetworkSecurity/venv\Library\include'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LE:/NetworkSecurity/venv\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='E:/NetworkSecurity/venv\Library\lib\tclstub86.lib'
